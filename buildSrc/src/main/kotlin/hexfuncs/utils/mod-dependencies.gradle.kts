...
abstract class HexfuncsModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexfuncsModDependenciesExtension>("hexfuncsModDependencies")
